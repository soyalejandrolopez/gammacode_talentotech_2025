...
<style>
    ...
    .store-info-header {
        background: linear-gradient(135deg, #FF0000, #FF0000 33%, #FCD116 33%, #FCD116 66%, #0033A0 66%);
        color: white;
        padding: 1.5rem;
        position: relative;
    }
    ...
    .contact-icon {
        width: 40px;
        height: 40px;
        background: linear-gradient(135deg, #FF0000, #FCD116, #0033A0);
        color: white;
        border-radius: 50%;
        display: flex;
        align-items: center;
        ...
        <div class="modern-card fade-in-up">
            <div class="modern-card-header">
                <h5 class="modern-card-title">
                    <i class="fas fa-store" style="color: var(--blue);"></i> Tienda: {{ $store->name }}
                </h5>
                <div>
