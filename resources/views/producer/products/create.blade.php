            ...
            <div class="modern-card fade-in-up">
                <div class="modern-card-header">
                    <h5 class="modern-card-title">
                        <i class="fas fa-plus-circle" style="color: var(--yellow);"></i> Añadir Nuevo Producto
                    </h5>
                </div>
                <div class="modern-card-body">
                    <p class="text-muted mb-0">
                        Completa el formulario para añadir un nuevo producto a tu tienda. Los campos marcados con <span class="text-danger">*</span> son obligatorios.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="modern-card fade-in-up" style="animation-delay: 0.1s;">
                <div class="modern-card-body">
                    <form action="{{ route('producer.products.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Describe tu producto, sus características y beneficios para los clientes.</div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="stock" id="stock" value="{{ old('stock', 0) }}" min="0" class="form-control @error('stock') is-invalid @enderror" required>
                                    @error('stock')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Código único para identificar tu producto.</div>
                                    @error('sku')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="form-check-input" role="switch">
                                    <label for="is_active" class="form-check-label">Activo</label>
                                    <div class="form-text">Los productos activos se mostrarán en tu tienda.</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="form-check-input" role="switch">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const formContainer = document.querySelector('.modern-card-body');
        ...
        if (imageInput) {
            imageInput.addEventListener('change', function() {
                ...
                if (this.files && this.files.length > 0) {
                    ...
                    previewTitle.innerHTML = '<i class="fas fa-images me-2" style="color: var(--blue);"></i> Vista previa de imágenes';
                    ...
                    for (let i = 0; i < this.files.length; i++) {
                        ...
                        if (file.type.match('image.*')) {
                            ...
                            reader.onload = function(e) {
                                ...
                                imgContainer.style.boxShadow = '0 5px 15px rgba(0,0,0,0.1)';
                                imgContainer.style.transform = 'perspective(500px) rotateY(0deg)';
                    ...
                    // Insertar la vista previa después del input de imágenes
        ...
        document.getElementById('saveCategory').addEventListener('click', function() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    const formElement = document.querySelector('form[action="{{ route('producer.products.store') }}"]');
